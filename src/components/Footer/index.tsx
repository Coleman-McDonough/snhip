...
const Footer = () => {
  return (
    <>
      <footer className="dark:bg-gray-dark relative z-10 items-center bg-white pt-16 md:pt-20 lg:pt-24">
        ...
        <div className="absolute right-0 top-14 z-[-1]">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#365f01" />
            <mask
              id="mask0_94:899"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#365f01" stopOpacity="0.62" />
                <stop offset="1" stopColor="#365f01" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#365f01" stopOpacity="0" />
                <stop offset="1" stopColor="#365f01" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
